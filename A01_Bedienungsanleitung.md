# Bedienungsanleitung Präanalysetool
...
|[2. Installationsanleitung](#2-installationsanleitung) |3|
|[&nbsp; 2.1. QGIS installieren](#21-qgis-installieren) |3|
|[&nbsp; 2.2. Erweiterung installieren](#22-erweiterung-installieren) |3|
|[3. Hilfe](#3-hilfe) |5|
|[4. Projekt eröffnen](#4-projekt-eröffnen) |6|
|[5. Grundlagen](#5-grundlagen) |7|
|[6. Stochastisches Modell](#6-stochastisches-modell)|9|
|[&nbsp; 6.1. Lage und Höhe](#61-lage-und-höhe) |9|
|[&nbsp; 6.2. Höhe](#62-höhe) |9|
|[7. Netzdefinition](#7-netzdefinition)|11|
|[&nbsp; 7.1. Knoten](#71-knoten) |11|
|[&nbsp; 7.2. Beobachtungen](#72-beobachtungen) |12|
|[8. Qualität und Zuverlässigkeit](#8-qualität-und-zuverlässigkeit) |14|
|[&nbsp; 8.1. Zuverlässigkeit](#81-zuverlässigkeit) |14|
|[&nbsp; 8.2. Relative Genauigkeit und relative Zuverlässigkeit](#82-relative-genauigkeit-und-relative-zuverlässigkeit) |15|
|[9. Berechnung](#9-berechnung) |16|
|[10. Resultate](#10-resultate) |17|
|[11. Literatur](#11-literatur) |18|
...
![Projekt erstellen](./images/plugin/1_openProject.png)\
...
![Stochastisches Modell](./images/plugin/2_stochMod.png)\
...
![Netzdefinition](./images/plugin/3_NetDef.png)\
...
## 8. Qualität und Zuverlässigkeit
...
![Qualität / Zuverlässigkeit](./images/plugin/4_qualRel.png)\
...
![Berechnung](./images/plugin/5_calc.png)\
...
![Resultate](./images/plugin/6_results.png)\
